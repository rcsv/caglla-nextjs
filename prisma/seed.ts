...
/**
 * Seeds the database with initial timezone, locale, and currency records.
 *
 * Inserts predefined data into the `mstTimezone`, `mstLocale`, and `mstCurrency` tables, skipping any duplicate entries.
 */
async function main() {
  // --- Timezones ---
